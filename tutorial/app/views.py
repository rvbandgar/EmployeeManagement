...
def add_employee_data(request):
    if request.method=="POST":
        ...
        Employee.objects.create(emp_first_name=emp_first_name,emp_last_name=emp_last_name,
                                emp_designation=emp_designation).save()
        response={
            'status':True,
            'status_code':200,
        ...
        return render(request,'app/addEmployee.html',{'baseUrl':baseUrl})
...
def edit_employee_data(request, id):
    if request.method == "POST":
        ...
        return render(request, 'app/editEmployee.html', {'baseUrl': baseUrl, 'emp_id': id, 'employee': employee})
...
def show_data(request):
    if request.method == "POST":
        ...
        return render(request, 'app/employee.html', {'employee_object': employee_object})
